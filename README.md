...
|---|---|---|---|---|
| ICAO hex | Six hex characters | FlightAware aircraft page (registration known) · observing provider's globe (no registration) | Remaining globes, then FlightAware live hex lookup | Invalid or `~` target |
